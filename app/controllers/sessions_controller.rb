class SessionsController < ApiApplicationController
  ...
  def create
    ...
    render json: { id: 'google', name: 'Vouk', token: SecureRandom.base58(24), img: 'https://lh3.googleusercontent.com/a-/AOh14Gj9TlteFV5rTP1lO1f4-Oc85AWqk-OFrErJkU8zdg=s96-c' }
  end
