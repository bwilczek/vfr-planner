...
L.DivIcon.SVGIcon = L.DivIcon.extend({
    ...
    _createPath: function() {
        ...
        var path = '<path class="' + className + '" d="' + pathDescription +
            ...
            '" fill="' + fill + '" fill-opacity="' + fillOpacity + '" style="transform-origin:center;transform:rotate('+rotation+'deg)"/>'
...
L.FiveMinuteIcon = L.DivIcon.SVGIcon.extend({
  _createPathDescription: function() {
    return 'M 10,0 10,20 z'
  },
  _createCircle: () => ''
})

L.OneMinuteIcon = L.DivIcon.SVGIcon.extend({
  _createPathDescription: function() {
    return 'M 5,0 5,10 z'
  },
  _createCircle: () => ''
